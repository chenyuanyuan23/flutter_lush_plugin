...
class FlutterLushPlugin {
  static const MethodChannel _channel = MethodChannel('flutter_lush_plugin');
  ...
  static void initCallBack(
    ...
    _channel.setMethodCallHandler((MethodCall call) {
      switch (call.method) {
        ...
        case "toyMsg":
          // 当收到玩具错误消息时的处理
          debugPrint('toy err========${call.arguments}');
          break;
        default:
          break;
      }
  ...
  //销毁
  static Future cleanHandler() async {
    await _channel.invokeMethod('cleanHandler');
  }
